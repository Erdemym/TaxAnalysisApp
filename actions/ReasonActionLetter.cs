...
public class ReasonLetterAction
{
    ...
    {
        string reasonText =
            $"yazısında yer alan hususlar doğrultusunda; {GlobalVariables.VtrTaxPeriod.Split(',')[0]} yılı işlemlerinin sahte belge kullanma yönünden incelenmesi talep edilen ve ilgili dönemde sadece “kendine ait veya kiralanan gayrimenkullerin kiraya verilmesi veya leasingi (kendine ait binalar, devre mülkler, araziler, müstakil evler, vb.)” faaliyet nedeniyle “0012” kodundan Gelir Vergisi mükellefiyeti bulunmakla birlikte KDV yönünden mükellefiyet kaydı bulunmadığı tespit edilen mükellefin, tespit edilen sahte belge kullanım tutarı ({Setting.Amount.ToString("N0").Replace(',', '.')},00.-TL ve altında) dikkate alındığında; Bakanlık Makamının 24.05.2024 tarih ve 525 sayılı Olurları ile Başkanlık Makamının 18.07.2024 tarih ve 707 sayılı Olurları ile vergi incelemelerinin etkinliğinin ve verimliliğinin artırılması, belirlenen ilke, standart ve yöntemlere uygun olarak kurumsal bir şekilde ve plan dahilinde gerçekleşmesinin sağlanması, iş planlamasını olumsuz yönde etkileyen vergi incelemelerinin tespiti ile bu tür vergi incelemeleri hakkında gerekli önlemlerin alınması hususları doğrultusunda Vergi Müfettişlerinin daha etkin ve verimli incelemeler yapmasını sağlamak amacıyla etkin ve verimli olmayacağı değerlendirilen işbu inceleme talebinin İhbar ve İnceleme Taleplerini Değerlendirme Komisyonlarının Oluşturulması ile Çalışma Usul ve Esaslarına İlişkin Yönerge'nin 10/2-g bendi gereğince hıfz edilmesine karar verilmiştir.";
        reasonText = beginingOfReasonText + reasonText;
        return reasonText;
    }
    ...
    {
        string reasonText =
            $"yazısında yer alan hususlar doğrultusunda; {GlobalVariables.VtrTaxPeriod.Split(',')[0]} yılı işlemlerinin sahte belge kullanma yönünden incelenmesi talep edilen ve ilgili dönemde sigorta acentelerinin faaliyeti nedeniyle kurumlar vergisi mükellefiyeti bulunmakla birlikte KDV yönünden mükellefiyet kaydı bulunmadığı tespit edilen mükellefin, tespit edilen sahte belge kullanım tutarı ({Setting.Amount.ToString("N0").Replace(',', '.')},00.-TL ve altında) dikkate alındığında; Bakanlık Makamının 24.05.2024 tarih ve 525 sayılı Olurları ile Başkanlık Makamının 18.07.2024 tarih ve 707 sayılı Olurları ile vergi incelemelerinin etkinliğinin ve verimliliğinin artırılması, belirlenen ilke, standart ve yöntemlere uygun olarak kurumsal bir şekilde ve plan dahilinde gerçekleşmesinin sağlanması, iş planlamasını olumsuz yönde etkileyen vergi incelemelerinin tespiti ile bu tür vergi incelemeleri hakkında gerekli önlemlerin alınması hususları doğrultusunda Vergi Müfettişlerinin daha etkin ve verimli incelemeler yapmasını sağlamak amacıyla etkin ve verimli olmayacağı değerlendirilen işbu inceleme talebinin İhbar ve İnceleme Taleplerini Değerlendirme Komisyonlarının Oluşturulması ile Çalışma Usul ve Esaslarına İlişkin Yönerge'nin 10/2-g bendi gereğince hıfz edilmesine karar verilmiştir.";
        reasonText = beginingOfReasonText + reasonText;
        return reasonText;
    }
